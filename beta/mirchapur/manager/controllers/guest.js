  ...
  .controller('guestController', function($scope, $http, $interval, $cookies) {
    ...
    $scope.fetchVisits = function(userKey){    
	      ...
	      var data = {};
              ...
              $http({
                method  : 'POST',
                url     : 'https://accelerateengine.app/foodengine/services/deskfetchuserhistory.php',
                data    : data,
    ...
    $scope.search = function(id){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/deskfetchuser.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
    ...
    $scope.manageUserBlock = function(userid, status) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/desksetuserblock.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
