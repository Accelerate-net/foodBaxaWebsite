...
$scope.initReservations = function(){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/deskfetchreservations.php',
        data    : data,
...
$scope.initReservations();
      ...
      $scope.getFilterTableDisplayCheck = function(historyFlag){
         ...
         $scope.confirmComplete = function(code){
	        ...
	        $http({
	          method  : 'POST',
	          url     : 'https://accelerateengine.app/foodengine/services/deskmarkreservationcompleted.php',
	          data    : data,
	          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	         })
	         .then(function(response) {
...
console.log(data)
	...
	$scope.initSeatPlan = function(){
		...
		$scope.seatPlanError = "";
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/deskfetchtables.php',
	        data    : data,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	       })
	       .then(function(response) {
	...
	$('#seatingPlanViewModal').modal('show');
      ...
      $scope.allocateSeats = function(code, list){	      
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/deskassigntable.php',
	        data    : data,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	       })
	       .then(function(response) {
      ...
      $scope.deallocateSeats = function(code, list){	      
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/deskreleasealltables.php',
	        data    : data,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	       })
	       .then(function(response) {
      ...
      $scope.confirmRelease = function(code, reserveID){
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/deskreleasetables.php',
	        data    : data,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	       })
	       .then(function(response) {
