...
.controller('failedOrdersController', function($scope, $http, $interval, $cookies) {
      ...
      $http.get("https://accelerateengine.app/foodengine/services/getoutletstatus.php?outlet="+localStorage.getItem("branchCode")).then(function(data) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/failedorders.php',
        data    : data,
  ...
  .controller('completedOrdersController', function($scope, $http, $interval, $cookies) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/filterorders.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
  ...
  $('#headerLoading').show(); $("body").css("cursor", "progress");
    ...
    //Outlet Open/Close status
    $scope.isOutletClosed = false;
    $http.get("https://accelerateengine.app/foodengine/services/getoutletstatus.php?outlet="+temp_outlet)
    .then(function(response) {
    ...
    $scope.triggerOutlet = function(close_reason) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/setoutletstatus.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
      })
      .then(function(response) {
    ...
    $scope.setDelay = function(delay_reason) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/setoutletdelay.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
      })
      .then(function(response) {
    ...
    $scope.initializePendingOrders = function(){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/fetchorders.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
    ...
    $scope.confirmOrder = function(orderid){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/confirmorder.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
    ...
    $scope.rejectOrderConfirm = function(orderid){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/rejectorder.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
    ...
    $scope.assignAgent = function(orderid){
      ...
      $http.get("https://accelerateengine.app/foodengine/services/fetchroles.php?branch="+temp_branch+"&role=AGENT").then(function(response) {
    ...
    $scope.dispatchOrder = function(orderid, agentcode){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/dispatchorder.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
