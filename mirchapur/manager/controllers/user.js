...
.config(['$qProvider', function ($qProvider) {
  ...
  .controller('userOrdersController', function($scope, $http, $interval, $cookies) {
    ...
    $scope.search = function(id){
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/fetchusersadmin.php',
        data    : data,
       ...
       .then(function(response) {
            if(response.data.status){
              ...
              $http({
                method  : 'POST',
                url     : 'https://accelerateengine.app/foodengine/services/orderhistoryadmin.php',
                data    : data,
                headers : {'Content-Type': 'application/x-www-form-urlencoded'}
               })
               .then(function(response) {
...
console.log(response)
    ...
    $scope.manageUserBlock = function(userid, status) {
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/setuserblock.php',
        data    : data,
        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
       })
       .then(function(response) {
