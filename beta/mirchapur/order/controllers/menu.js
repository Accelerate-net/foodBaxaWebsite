...
.config(['$qProvider', function ($qProvider) {
	          ...
	          if (!place.geometry) {
	            ...
	            return;
		          ...
		          localStorage.setItem("location", JSON.stringify(temp));
		          	...
		          	//Try updating outlet:
			        $http.get("https://accelerateengine.app/foodengine/services/googleoutletassigner.php?lat="+lat+"&lng="+lng+"&version=web").then(function(response) {
    ...
    .controller('MenuController', function($scope, $http, $cookies) {
      ...
      if($cookies.get("user")){
        ...
        {       
          ...
          $http({
            method  : 'POST',
            url     : 'https://accelerateengine.app/foodengine/services/regeneratetoken.php',
      ...
      $scope.checkFeedback = function(){      	      	
          ...
          $http({
            method  : 'POST',
            url     : 'https://accelerateengine.app/foodengine/services/getlatestorderid.php',
            data    : data, //forms user object
            headers : {'Content-Type': 'application/x-www-form-urlencoded'}
           })
          .then(function(response) {
      ...
      $scope.submitFeedback = function(){
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/postreview.php',
	        data    : data,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'},
	        timeout : 10000
	       })
      ...
      $scope.getPopularAreas = function(cityName){
	      $http.get("https://accelerateengine.app/foodengine/services/popularareas.php?city="+cityName).then(function(response) {
	...
	if(document.getElementById('myNewLocationWindow').style.display == "block"){
      ...
      $scope.updateOutlet = function(lat_lng_code){
	      ...
	      $http.get("https://accelerateengine.app/foodengine/services/googleoutletassigner.php?lat="+saved_coords[0]+"&lng="+saved_coords[1]+"&version=web").then(function(response) {
	       	      var outletInfo = response.data.response;
    ...
    $scope.isRenderLoaded = false;                    
                    ...
                    $http({
                        method: 'GET',
                        url: 'https://accelerateengine.app/foodengine/services/fetchmenuweb.php?outlet='+outletcode,
                        timeout: 10000
                    })
                    .then(function (response) {
    ...
    $scope.featureMenu = {};
    $http.get("https://accelerateengine.app/foodengine/services/featuremenuweb.php?outlet="+outletcode).then(function(response) {        
