...
.config(['$qProvider', function ($qProvider) {
  ...
  .controller('settingsController', function($scope, $http, $interval, $cookies) {
    ...
    $scope.outletCode = localStorage.getItem("branch");
      ...
      $http({
        method  : 'POST',
        url     : 'https://accelerateengine.app/foodengine/services/fetchadmininfo.php',
        data    : data,
     ...
     $scope.saveChanges = function(){
     	...
     	if(!name_regex.test($scope.admin.name)){
     		...
     		$http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/saveadmininfo.php',
	        data    : mydata,
	        headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	       })
	       .then(function(response) {
     ...
     $scope.getOutletSettings = function(){
	        ...
	        $http({
	          method  : 'POST',
	          url     : 'https://accelerateengine.app/foodengine/services/getsettingsadmin.php',
	          data    : admin_data,
	          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	         })
	         .then(function(response) {		
     ...
     $scope.setPayment = function(option){
	        ...
	        $http({
	          method  : 'POST',
	          url     : 'https://accelerateengine.app/foodengine/services/changesettingsadmin.php',
	          data    : admin_data,
	          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	         })
	         .then(function(response) {
