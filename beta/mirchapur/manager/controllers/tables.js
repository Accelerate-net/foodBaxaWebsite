  ...
  .controller('tablesController', function($scope, $http, $interval, $cookies) {
    ...
    $scope.outletCode = localStorage.getItem("branch");
      ...
      $scope.initSections = function(){
	      ...
	      $http({
	        method  : 'POST',
	        url     : 'https://accelerateengine.app/foodengine/services/deskfetchtablesections.php',
	        data    : data,
   ...
   /* Sections Operations */	
      ...
      $scope.confirmDeleteSection = function(code){
	        ...
	        $http({
	          method  : 'POST',
	          url     : 'https://accelerateengine.app/foodengine/services/deskdeletetablesection.php',
	          data    : data,
	          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	         })
	         .then(function(response) {
	...
	$scope.saveNewSection = function(){
		...
		if($scope.newSectionContent.name == "" || !(/^[a-zA-Z ]+$/.test($scope.newSectionContent.name))){
			...
			var data = {};
		        ...
		        $http({
		          method  : 'POST',
		          url     : 'https://accelerateengine.app/foodengine/services/deskaddtablesection.php',
		          data    : data,
		          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
		         })
		         .then(function(response) {	         	
	...
	/* Tables Operations */
      ...
      $scope.confirmDeleteTable = function(code){
	        ...
	        $http({
	          method  : 'POST',
	          url     : 'https://accelerateengine.app/foodengine/services/deskdeletetable.php',
	          data    : data,
	          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
	         })
	         .then(function(response) {
	...
	$scope.saveNewTable = function(){
		...
		if($scope.newTableContent.name == ""){
			...
			var data = {};
		        ...
		        $http({
		          method  : 'POST',
		          url     : 'https://accelerateengine.app/foodengine/services/deskaddtable.php',
		          data    : data,
		          headers : {'Content-Type': 'application/x-www-form-urlencoded'}
		         })
		         .then(function(response) {	         	
